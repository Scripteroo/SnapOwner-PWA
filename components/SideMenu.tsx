    ...
    <>
      ...
      <div className={`fixed top-0 left-0 bottom-0 z-[80] w-72 bg-white shadow-elevated transform transition-transform duration-300 ease-out ${open ? "translate-x-0" : "-translate-x-full"}`} style={{ paddingTop: "env(safe-area-inset-top, 12px)" }}>
        <div className="flex items-center justify-between px-5 py-4">
          <h2 className="text-[20px] font-bold text-lens-text tracking-tight">SnapOwner</h2>
        ...
        <div className="absolute bottom-8 inset-x-0 px-5">
          <p className="text-[9px] text-lens-secondary text-center leading-relaxed mb-3">
            SnapOwner is not a consumer reporting agency under the FCRA. Data provided is not a &quot;consumer report&quot; and may not be used for credit, employment, insurance, or tenant screening decisions.
          </p>
          <p className="text-[11px] text-lens-secondary text-center">SnapOwner v1.0</p>
        </div>
      </div>
    </>
  );
