    ...
    <div className="min-h-screen bg-white pb-24">
      ...
      <div className="px-5 py-8 max-w-2xl mx-auto">
        ...
        <ul className="text-sm text-gray-700 mb-4 list-disc pl-6 space-y-1">
          <li>Making credit granting decisions</li>
          <li>Employment screening or decisions</li>
        ...
        <h2 className="text-lg font-bold mt-6 mb-3">3. Prohibited Uses</h2>
        <p className="text-sm text-gray-700 mb-2">You agree NOT to use the Service for:</p>
        <ul className="text-sm text-gray-700 mb-4 list-disc pl-6 space-y-1">
          <li>Stalking, harassment, intimidation, or threatening any individual</li>
          <li>Any unlawful purpose or in violation of any applicable law</li>
          <li>Discrimination based on race, color, religion, sex, national origin, disability, familial status, or any other protected class</li>
          <li>Generating unsolicited commercial communications in violation of applicable laws</li>
          <li>Conducting surveillance of individuals for non-legitimate purposes</li>
          <li>Reselling or redistributing data obtained through the Service without written consent</li>
          <li>Circumventing usage limits, access controls, or security measures</li>
          <li>Any purpose that would violate the privacy or rights of property owners or other individuals</li>
        </ul>

        <h2 className="text-lg font-bold mt-6 mb-3">4. TCPA Compliance</h2>
        <p className="text-sm text-gray-700 mb-4">
          If you use phone numbers obtained through the Service to contact property owners, you agree to comply
        ...
        <h2 className="text-lg font-bold mt-6 mb-3">6. User Accounts and Credits</h2>
        <p className="text-sm text-gray-700 mb-4">
          The Service may offer free lookups, credit-based features, and premium subscriptions. Credit balances
          are non-transferable and may expire. We reserve the right to modify credit allocations, pricing, and
          feature availability at any time with reasonable notice.
        </p>
        ...
        <h2 className="text-lg font-bold mt-6 mb-3">9. Termination</h2>
        <p className="text-sm text-gray-700 mb-4">
          We may suspend or terminate your access to the Service at any time, without notice, for conduct that
          we believe violates these Terms, is harmful to other users, or is otherwise objectionable. Upon
          termination, your right to use the Service ceases immediately.
        </p>

        <h2 className="text-lg font-bold mt-6 mb-3">10. Governing Law</h2>
        <p className="text-sm text-gray-700 mb-4">
          ...
          shall be resolved exclusively in the state or federal courts located in Florida. You consent to the
          personal jurisdiction of such courts.
        </p>

        <h2 className="text-lg font-bold mt-6 mb-3">11. Changes to Terms</h2>
        <p className="text-sm text-gray-700 mb-4">
